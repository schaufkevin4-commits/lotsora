  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <footer className="border-t">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-2 px-4 py-5 sm:px-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
