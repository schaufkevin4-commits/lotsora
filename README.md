...
**Neuester Strukturstand 22.09.2026:** P2-6 beginnt mit einem übersichtlicheren Produkteditor: drei Bereiche, aufklappbare Zusatzangaben und dauerhaft sichtbarer öffentlicher Status. Eingaben bleiben beim Wechsel erhalten. Die finale Optik folgt auf Kevins ausdrückliche Klarstellung später. [Erster Aufbau, Prüfungen und nächste Schritte](docs/P2-6-STRUKTUR-2026-09-22.md). 141 Unit- und 11 Produktions-HTTP-Tests, Lint, Typen und Build bestanden; Desktop, 390/320 Pixel, Tastatur und geführte Eingabe live geprüft. Erste Nutzerbeurteilung und Übertragung auf weitere Seiten offen. Brain-KI wird synchronisiert; Lotsora lokal, kein Push/Deploy.
