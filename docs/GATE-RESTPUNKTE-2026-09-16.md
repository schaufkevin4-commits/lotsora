...
Die Abnahmeumgebung muss die Migrationen und Konfiguration des geprüften Codes enthalten. Aktuell wurden die 19 Migrationen nur auf `lotsora-integration` angewendet. Vor Übernahme in eine andere Umgebung sind vorhandene Dateien/Bildwerte/Artikelnummern zu prüfen und der ausschließlich serverseitige Upload-Verifier-Schlüssel zu konfigurieren; Details stehen im B5/N7-Abschluss.
