...
B4/F03 ist im lokalen Branch `codex/b4-veroeffentlichungsregeln` umgesetzt: Datenbankregeln, atomare Statuswechsel, Konfliktschutz und echte Parallel-/Rollbacktests. Details, API-Vertragsänderung und Umgebungsgrenzen stehen im [B4-Abschluss vom 14.09.2026](ABSCHLUSS-2026-09-14-B4.md). Die Migration gilt bisher nur in der isolierten Testinstanz. **Nächster Baublock: B3/F05 – Datei-/Produktlöschung und Uploadkompensation.** Größere Template-/Versions-/Importänderungen und der Livegang sind durch diesen Abschluss nicht freigegeben.
...
| B3 / F05 | Wiederholbare Datei-/Produktlöschung mit erhaltenem Fehler-/Objektbezug, Uploadkompensation | documents/products-Services, Löschactions, ggf. kleine Aufräumzustand-Migration | Kein als abgeschlossen ausgegebener Löschvorgang hinterlässt unberücksichtigte Dateien; Fehler gezielt nachholbar; IDs reserviert | Datei fehlt, Storage fällt aus, DB-Fehler, Wiederholung, Produkt-/Dokumentlöschung | DB und Storage sind keine gemeinsame Transaktion; keine generische Jobplattform nötig | 4–6 h |
| B5 + N7 | Uploadvertrag PDF/Bilder, MIME/Inhalt/Größe, authentifizierter Storage-Upload falls 10 MiB beibehalten; Produktbild und optionale Artikelnummer anschließen | dokument-actions, Dokument-/Bild-Services, Produktformular, save_product-RPC, privater Bucket, Passanzeige | Upload/Abbruch/Ersetzen/Löschen kontrolliert; Bild/Artikelnummer speicherbar; Artikelnummer weiterhin optional und gemäß PP-013 intern | Zulässige/unerlaubte Datei, falscher MIME, leer/zu groß, abgebrochener Upload, A/B, Bildtausch, vollständiger Formular-Rollback | Hostinggrenze heute verifiziert; konkrete Transportentscheidung vor Umsetzung; Live-Hostingtest später zusätzlich | 6–10 h |
...
Der Analyseauftrag vom 10.09. wurde vor Codeänderungen abgeschlossen. Kevin hat anschließend mit „dann starten wir jetzt weiter“ den Einstieg freigegeben. Nach der Nutzungspause wurde am 12.09. ausdrücklich der Abschluss des begonnenen Blocks verlangt; weitere Arbeit folgt am nächsten Termin. **Der erste Sicherheitsblock und B4 sind lokal umgesetzt und geprüft; kein Gesamt-Gate und kein Livegang wurden freigegeben.**
