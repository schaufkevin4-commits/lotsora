...
**Fortschritt 20.09.:** Gemeinsame Firmenzugänge, Einladungen und Teamrechte sind lokal umgesetzt und geprüft, einschließlich Live-Demo zweier Konten. [Abschluss und Grenzen](ABSCHLUSS-2026-09-20-FIRMENTEAMS.md). Nächster Einstieg: zusammenhängender Gesamtsystemcheck auf dem Teammodell und verbleibende N8-Nachweise; Gesamt-Gate weiter offen.

**Planänderung 20.09.:** Kevin hat die Richtungen A1–A5 angenommen und gemeinsame Firmenzugänge ausdrücklich in V1 vorgezogen. Nächster Baublock: Mitgliedschaften, Einladungen, Teamrechte und zugehörige Regressionen gemäß [Architekturbeschluss](ARCHITEKTURBESCHLUSS-2026-09-20.md). Den abschließenden Gesamtsystemcheck danach auf das Teammodell erweitern. Die ältere Aussage „Mehrbenutzer erst bei Pilotbedarf“ gilt nur noch für zusätzliche Brands/Mehrfirmenfunktionen, nicht für mehrere Nutzer derselben Firma.

Aktualisierung 19.09.: Der begrenzte Entwurfsblock zu Template-/Feldkennungen, Quellenvertrag, Herstellergrenze, Veröffentlichungsrevision und Produktidentität ist als [Architekturvorlage A1–A5](ARCHITEKTURVORLAGE-2026-09-19.md) ausgearbeitet und mit dem aktuellen Code abgeglichen. Empfehlungen und späteste Umsetzungszeitpunkte sind dokumentiert; fachliche Entscheidungen stehen noch aus. Keine große Implementierung, Gate- oder Livegang-Freigabe daraus ableiten. [Aktueller N8-Reststand](N8-RESTABNAHME-2026-09-19.md).
...
B5/N7 ist im Commit `1a19141` umgesetzt: authentifizierte direkte Uploads bis 10 MiB mit serverseitiger Inhaltsprüfung, Produktbild mit kontrolliertem Austausch und optionale interne Artikelnummer. 64 Unit- und 70 Integrationstests bestanden; gezielte Browserprüfung einschließlich Uploadabbruch abgeschlossen. Details und Grenzen stehen im [B5/N7-Abschluss vom 16.09.2026](ABSCHLUSS-2026-09-16-B5-N7.md). Die Migrationen gelten weiterhin nur in der isolierten Testinstanz. Der damalige nächste Baublock N9/F07 ist inzwischen lokal abgeschlossen (siehe Aktualisierung unten). Am 16.09. hat Kevin den bisherigen Push-Aufschub aufgehoben und die Übernahme von B4, B3 und B5/N7 nach main beauftragt. Größere Template-/Versions-/Importänderungen und der Livegang sind dadurch nicht freigegeben. Die verbleibenden Gate-Punkte stehen in der [aktuellen Übersicht](GATE-RESTPUNKTE-2026-09-16.md).
...
Aktualisierung 18.09.2026: N3 im beschriebenen V1-Umfang lokal abgeschlossen, noch uncommitted. Gemeinsame Passladung, erneuerbare Dateilinks, eingeschränkte Detail-Grants und Fehlerbehandlung sind geprüft. 93 Unit-/85 Integrations-/sieben separate HTTP-Tests; 21 Migrationen ausschließlich in `lotsora-integration`. [N3-Abschluss und Grenzen](ABSCHLUSS-2026-09-18-N3.md). N8/QR/proxy inzwischen lokal umgesetzt und geprüft; manuelle Restabnahme offen. Siehe [N8-Abschluss](ABSCHLUSS-2026-09-18-N8.md). Weitere Arbeit nur nach neuem Auftrag. Gesamt-Gate bleibt offen.
...
| N9 / F07 + UX-Abgleich – lokal abgeschlossen 16.09. | Autosave auf bestätigten Stand beziehen, Materialentfernung sichern, Publish mit pending/dirty koordinieren; Checkliste/Datenlücken/Editorablauf gegen PP-018/019 prüfen | ProduktFormular, MaterialAbschnitt, VeroeffentlichenAbschnitt, Dashboard | Keine still verlorenen Änderungen in geprüften Fällen; verständliche Fehler/Wiederholung; dokumentierte MUSS-Abweichungen erledigt oder ausdrücklich entschieden | Verzögerte/fehlgeschlagene Saves, nur Zeile entfernen, Navigation, zwei Tabs, Publish während Save, Erstprodukt bis erster Pass | Umfang der bestehenden geführten/klappbaren UX nicht durch neue KI-UX ersetzen | 4–8 h |
| N3 – lokal abgeschlossen 18.09. | Gemeinsame Passladung, aktuelle Serverabrufe, erneuerbare Bild-/Dokumentlinks und Fehlerzustände | Öffentlicher Client/Loader, Dateirouten, Passanzeige, Detail-Grants | Im V1-Vertrag geprüft; Restlaufzeit und laufende Lesungen ausdrücklich begrenzt | 93 Unit-, 85 Integrations- und sieben separate HTTP-Tests sowie Browserfälle | 21 Migrationen nur in lotsora-integration; uncommitted; kein Gate/Livegang | abgeschlossen |
| N8 + QR + proxy – lokal umgesetzt 18.09., manuelle Restabnahme offen | Eindeutige Feld-IDs, Tastatur/Fokus/Kontrast/Mobilansicht; QR-Rand vier Module; middleware-Konvention migrieren | Pass-/Editor-/Dokumentkomponenten, lib/qr.ts, QR-Aktionen, middleware/proxy | Lokaler Grundpass protokolliert; Export technisch mit ausreichendem Rand; Auth-/Routenschutz erhalten | Tastatur, 320/375px/Zoom, Screenreader-Stichprobe, SVG/PNG dekodieren, Auth-Regressionsfälle; Druck mit Handys spätestens vor Kundeneinsatz | Physischer Test benötigt Drucker/Handys und festgelegte Etikettengröße | 4–6 h |
...
| Mehrere Nutzer derselben Firma – in V1 vorgezogen | Ausdrücklicher Beschluss 20.09.; nächster Team-Baublock | Mitgliedschaften, Einladungen/Annahme, einfache Teamrechte, Migration bestehender Firmen | Gesamte RLS-/Storage-Matrix A1/A2/B/anon, letzter Verantwortlicher, Entzug, Nutzerlöschung, fortsetzbare Dateivorgänge |
| Brands/mehrere Firmen je Nutzer | Weiterhin erster bestätigter Pilotbedarf | Brandzuordnung, Firmenauswahl, getrennte Verantwortliche | Eigener begrenzter Auftrag; durch Teamzugänge nicht automatisch abgedeckt |
